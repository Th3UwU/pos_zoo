...
button_search.addEventListener('click', buttonEvent);

async function buttonEvent(): Promise<void>
{
	query_container.innerHTML = '';
	let isNumber: boolean = (!isNaN(parseInt(search_bar.value)) || search_bar.value != '');
